...
export function getBossBuffsHtml(c) {
    ...
    if (c.passiveStates['BOSS_BUFF_DAMAGE_REFLECTION']) html += `<span title="Miroir Épineux (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(244, 63, 94, 0.15); color: #f43f5e; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(244, 63, 94, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">all_out</span>Miroir Épineux</span>`;
    if (c.passiveStates['BOSS_BUFF_PHYSICAL_SHROUD']) html += `<span title="Voile Éthéré (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(203, 213, 225, 0.15); color: #cbd5e1; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(203, 213, 225, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">blur_on</span>Voile Éthéré</span>`;
    if (c.passiveStates['BOSS_BUFF_MAGIC_SHROUD']) html += `<span title="Silencieux (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(129, 140, 248, 0.15); color: #818cf8; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(129, 140, 248, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">blur_off</span>Silencieux</span>`;
    if (c.passiveStates['BOSS_BUFF_FRENZY']) html += `<span title="Rage Sanguinaire (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(239, 68, 68, 0.15); color: #ef4444; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(239, 68, 68, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">swords</span>Rage Sang.</span>`;
    if (c.passiveStates['BOSS_BUFF_LIFESTEAL_AURA']) html += `<span title="Aura Vampirique (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(220, 38, 38, 0.15); color: #dc2626; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(220, 38, 38, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">water_drop</span>Vampirisme</span>`;
    if (c.passiveStates['BOSS_BUFF_REGENERATION']) html += `<span title="Régénération (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(52, 211, 153, 0.15); color: #34d399; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(52, 211, 153, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">healing</span>Régén.</span>`;
    if (c.passiveStates['BOSS_BUFF_MANA_OPPRESSION']) html += `<span title="Oppression Magique (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(168, 85, 247, 0.15); color: #a855f7; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(168, 85, 247, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">do_not_disturb</span>O. Magique</span>`;
    if (c.passiveStates['BOSS_BUFF_FREEZE_ON_HIT']) html += `<span title="Gel au touché (Boss Buff)" style="cursor: help; font-size: 0.75rem; background: rgba(34, 211, 238, 0.15); color: #22d3ee; padding: 0.15rem 0.5rem; border-radius: 6px; border: 1px solid rgba(34, 211, 238, 0.3); font-weight: 600; display: inline-flex; align-items: center; gap: 0.2rem;"><span class="material-symbols-outlined text-sm">ac_unit</span>Gel</span>`;
