...
public class DataInitializerService {
        ...
        public void initStandardEntities() {
                ...
                rangsVoies.put("Voie de la Raison",
                                Map.of(1, "Air", 2, "Vibration", 3, "Vide", 4, "Déviation", 5, "Gravité"));
                rangsVoies.put("Voie de la Sûreté",
                                Map.of(1, "Eau", 2, "Glace", 3, "Sang", 4, "Vapeur", 5, "Pression"));
                rangsVoies.put("Voie de Trahison",
                                Map.of(1, "Neige", 2, "Acide", 3, "Poison", 4, "Corrosion", 5, "Friction"));
                rangsVoies.put("Voie de la Consolidation",
                                Map.of(1, "Terre", 2, "Métal", 3, "Sable", 4, "Poussière", 5, "Atome"));
                rangsVoies.put("Voie de la Conviction",
                                Map.of(1, "Lave", 2, "Cristaux", 3, "Verre", 4, "Fibre", 5, "Tension"));
                ...
                passifsVoies.put("Voie de la Sûreté",
                                "Accumule des [c=shield]points de Sûreté[/c] (10/tour et 35% du [c=mana]mana[/c] dépensé).\nÀ [c=warning]100 points[/c] :\n- Si atteint en lançant un sort : octroie [c=crit]+15% de Critique[/c] (2 tours) et [c=heal]+25% de Soins prodigués[/c] (3 tours).\n- Si atteint passivement en début de tour : octroie [c=crit]+25% de Critique[/c] (1 tour) et restaure [c=mana]25% du mana manquant[/c].\n \nÀ chaque niveau, vous gagnez : [c=mana]+12 Mana[/c], [c=resist]+1 Résistance[/c] et [c=mana]+2 Régen Mana[/c].");
                passifsVoies.put("Voie de Trahison",
                                "Une fois par tour, vos [c=physic]attaques physiques[/c] infligent des [c=brut]dégâts bruts[/c] bonus [c=heal]qui vous soignent[/c] :\n[ul][li][c=brut]+10%[/c] de base[/li][li][c=brut]+20%[/c] si la cible a moins de 50% [c=pv]PV[/c][/li][li][c=brut]+15%[/c] si elle a un malus[/li][/ul]\n \nÀ chaque niveau, vous gagnez : [c=physic]+1 Force[/c], [c=speed]+1 Vitesse[/c] et [c=crit]+2 Critique[/c].");
                passifsVoies.put("Voie de la Consolidation",
                                "Au début de chaque tour :\nSi vous avez plus de 20% de vos [c=pv]PV max[/c], vous perdez 5% de vos [c=pv]PV max[/c] et gagnez un [c=shield]Bouclier[/c] équivalent à 10% de vos [c=pv]PV actuel[/c] (dure 1 tour).\nSi vous avez 20% de vos [c=pv]PV max[/c] ou moins, vous gagnez [c=armor]+20% d'Armure[/c] et de [c=resist]Résistance[/c] pendant 1 tour.\n \nÀ chaque niveau, vous gagnez : [c=pv]+5 PV[/c], [c=armor]+2 Armure[/c] et [c=resist]+2 Résistance[/c].");
                ...
                passifsVoies.put("Voie de la Création",
                                "Chaque tour, le 1er sort lancé consomme un [c=heal]bourgeon[/c] s'il vous en reste en stock.\nVoici les effets du [c=heal]bourgeon[/c] pour chaque type de sort :\n[ul][li]Un sort Instantané devient [c=mana]gratuit[/c] (sauf coût en graine)[/li][li]Un sort Banal devient [c=warning]Instantané[/c][/li][li]Un sort Canalisé octroie un [c=shield]bouclier[/c] (50% du [c=mana]mana[/c] dépensé, persistant toute la durée de la canalisation)[/li][/ul]\n \nÀ chaque niveau, vous gagnez : [c=pv]+5 PV[/c], [c=armor]+1 Armure[/c] et [c=heal]+2 Régen PV[/c].");
                ...
                passifsVoies.put("Voie de la Violence",
                                "Gère des cumuls d'[c=warning]Inspiration[/c] ou d'[c=power]Expiration[/c] (max 7) en lançant les sorts correspondants.\nLancer un sort de l'autre type (Swap) consomme les cumuls actuels et octroie un bonus pendant 2 tours si vous avez 4 cumuls ou plus :\n[ul][li]Swap entre 4-6 cumuls d'[c=power]Expiration[/c] : [c=physic]+30% Force[/c] | à 7 cumuls : [c=physic]+60% Force[/c][/li][li]Swap entre 4-6 cumuls d'[c=warning]Inspiration[/c] : [c=crit]+100% Critique[/c] | à 7 cumuls : [c=crit]+200% Critique[/c][/li][/ul]Attention : Si vous avez 6 cumuls ou plus, chaque nouveau sort du [b]même type[/b] que vous lancez vous infligera une [c=warning]Brûlure[/c] (15% [c=power]Puissance[/c] + 15% [c=physic]Force[/c] par tour, pendant 3 tours).\n \nÀ chaque niveau, vous gagnez : [c=mana]+8 Mana[/c], [c=power]+1 Puissance[/c] et [c=physic]+1 Force[/c].");

                String[] voies = {
                                "Voie de la Raison", "Voie de la Sûreté", "Voie de Trahison",
                                "Voie de la Consolidation",
                                "Voie de la Conviction", "Voie de la Création", "Voie de la Destruction",
                                "Voie de la Violence"
                };
