        ...
        public void initStandardEntities() {
                ...
                for (Spiritualite sp : spiritualiteRepository.findAll()) {
                        if ("Esprit".equals(sp.getNom())) {
                                ...
                                sp.setPassiveDescription(
                                                "Gère une jauge affectée par vos sorts du Karma ([c=purple]Ténèbres -1[/c], [c=karma]Harmonie vers 0[/c], [c=warning]Esprit +1[/c]). Selon votre état actuel, vous gagnez des bonus [c=karma]sur TOUS vos sorts[/c] :\n[ul][li]À [c=warning]0[/c] ([c=karma]Harmonie[/c]) : Chaque sort lancé régénère [c=heal]2% PV et Mana Max[/c].[/li][li][c=purple]État Ténèbres[/c] (jauge < 0) : [c=purple]+5% Dégâts (Phy/Mag)[/c] par point (max +15%).[/li][li][c=warning]État Esprit[/c] (jauge > 0) : Coût des sorts [c=mana]réduit de 5%[/c] par point (max -15%).[/li][li]À [c=warning]+4 ou -4[/c] : verrouille la magie karmique (sauf sorts d'[c=karma]Harmonie[/c]) pendant [c=warning]6 tours[/c] (plus aucun bonus d'état), mais confère un buff d'[c=armor]Illumination (+20% Armure/Résist et -100% Coût du sort)[/c] ou de [c=power]Corruption (+50% Dégâts)[/c].[/li][/ul]Astuce : On peut réduire le timer de verrouillage en lançant des sorts d'[c=karma]Harmonie[/c].");
                        }
                        spiritualiteRepository.save(sp);
                }
